...
const NovoClientePage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.telefono.trim()) {
      ...
      newErrors.telefono = "Formato: +34 640 123 456";
    }
  ...
  const handleInputChange = (e) => {
    ...
    // Aplicar máscaras
    if (name === "telefono") {
      newValue = formatPhoneES(value);
    } else if (name === "codigoPostal") {
      newValue = formatPostalCodeES(value);
    } else if (name === "tipo") {
  ...
  const formatPhoneES = (value) => {
    // Remove todos os caracteres não numéricos
    const numbers = value.replace(/\D/g, "");

    // Se começar com 34, adiciona +
    if (numbers.startsWith("34")) {
      const remaining = numbers.substring(2);
      if (remaining.length <= 9) {
        return `+34 ${remaining.substring(0, 3)} ${remaining.substring(3, 6)} ${remaining.substring(6, 9)}`.trim();
      }
    }
  ...
  const formatPostalCodeES = (value) => {
    const numbers = value.replace(/\D/g, "");
    if (numbers.length <= 5) {
          ...
          <div className="container">
            ...
            >
              <div className="dashboard-panel" style={{ maxWidth: "500px" }}>
                ...
                >
                  O cliente {formData.nombre} {formData.apellidos} foi
                  cadastrado no sistema. Redirecionando para a lista de
                  clientes...
                </p>
                <div
            ...
            <div style={{ marginBottom: "32px" }}>
              ...
              {selectedTipo && (
                ...
                >
                  ...
                  : Cliente receberá {selectedTipo.descuento}% de desconto em
                  todos os serviços.
                </div>
              )}
            </div>
