...
const VehicleServicesPage = () => {
  ...
  useEffect(() => {
    ...
    // Find customer
    const foundCustomer = mockCustomers.find(c => c.id === foundVehicle.clienteId);
    setCustomer(foundCustomer);

    // Filter services for this vehicle
    const vehicleServices = mockServiceHistory.filter(s => s.vehiculoId === vehicleId);
  ...
  return (
    <>
      <CommonPageHero title={`Servicios - ${vehicle.marca} ${vehicle.modelo}`} />
            ...
            <div className="service-card-style-2 p-4">
              <div className="row align-items-center">
                <div className="col-md-8">
                  <h2 className="title mb-2">{vehicle.marca} {vehicle.modelo} ({vehicle.año})</h2>
                  <div className="row">
                    <div className="col-md-6">
                      <p className="desp mb-1"><strong>Propietario:</strong> {customer?.nombre} {customer?.apellidos}</p>
                      <p className="desp mb-1"><strong>Matrícula:</strong> {vehicle.matricula}</p>
                    </div>
                    <div className="col-md-6">
                      <p className="desp mb-1"><strong>Color:</strong> {vehicle.color}</p>
                      <p className="desp mb-1"><strong>Kilometraje:</strong> {vehicle.kilometraje.toLocaleString()} km</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4 text-md-end">
                  <div className="service-stats">
                    <span className="badge bg-primary fs-6">{services.length} servicios realizados</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-center flex-wrap">
              <div>
                ...
                <p className="text-muted">Gestión completa de servicios del vehículo</p>
              </div>
