    ...
    const usuarios = [
      {
        ...
        telefono: "+34 640 123 456",
        role: "Administrador",
        especialidad: "Gestión del Sistema",
        fechaContratacion: new Date("2024-01-01").toISOString(),
        calificacion: 5.0,
      ...
      },
      {
        ...
        telefono: "+34 640 123 457",
        role: "Técnico Senior",
        especialidad: "Chapa y Pintura",
        fechaContratacion: new Date("2024-02-01").toISOString(),
        calificacion: 4.8,
      ...
      {
        nombre: "Especialista",
        apellidos: "Chapa y Pintura",
        email: "chapa@loyolamotors.com",
        telefono: "+34 640 123 458",
        role: "Especialista en Chapa y Pintura",
        especialidad: "Restauración Completa",
        fechaContratacion: new Date("2024-03-01").toISOString(),
        calificacion: 4.9,
      ...
      },
      {
        nombre: "Jefe",
        apellidos: "Taller",
        email: "jefe@loyolamotors.com",
        telefono: "+34 640 123 459",
        role: "Jefe de Taller",
        especialidad: "Supervisión y Gestión",
        fechaContratacion: new Date("2024-01-15").toISOString(),
        calificacion: 4.7,
        serviciosCompletados: 8,
        activo: true,
        ultimoLogin: new Date().toISOString(),
      },
    ];
