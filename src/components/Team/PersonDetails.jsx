...
const personData = {
  id: 1,
  name: "José Antonio Loyola",
  title: "Director General",
  quote:
    `"Con más de 20 años de experiencia en el sector automotriz, en Loyola Motors nos dedicamos a ofrecer servicios de chapa y pintura de la más alta calidad. Nuestro compromiso es devolver a cada vehículo su aspecto original, utilizando las mejores técnicas y materiales del mercado."`,
