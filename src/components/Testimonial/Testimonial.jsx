...
const Testimonial = () => {
  ...
  const reviewSchema = (item) => ({
    ...
    "itemReviewed": {
      "@type": "AutoRepair",
      "name": "Loyola Motors Valencia",
	  "image": "/footer-logo.png",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "C/ Sant Ignasi de Loiola, 21-BJ IZ",
    ...
    <div className="container">
      ...
      <div className="ak-testimonal-controll">
        ...
        <div className="testimonal-controll" data-aos="fade-left">
          ...
          >
            <span>Siguiente</span> <img src="/assets/img/icon/next.svg" alt=".." />
          </button>
        </div>
      </div>
      ...
      <div className="ak-testimonal" data-aos="fade-up">
        ...
        <div className="testimonal-img">
          <img src={testimaonialBgImg} alt="Coches esperando para ser reparados en el taller de Loyola Motors" />
        </div>
      </div>
    </div>
  );
